...
export const getAllPackagesByAdmin = async ({ adminId }: any) => {
  return await api.get(`${urlPath}/admin/${adminId}`, configOptions);
};
...
export const updatePackageStatusByPIN = async ({ pin, signedBy }: any) => {
