...
import { IonToolbar, IonTitle, IonContent, IonCard, IonItem, IonIcon, IonLabel,  IonProgressBar, IonButton, IonAlert, IonSelect, IonSelectOption, IonItemGroup,  IonDatetime, IonGrid, IonRow, IonCol, IonInput, } from '@ionic/react';
...
const CreateContainer: React.FC<ContainerProps> = ({ parkingType }) => {
    ...
    return (<>
        <IonToolbar color='primary'>
            <IonTitle><h1>Crear Parqueadero</h1></IonTitle>
        </IonToolbar>
        <IonContent>
            <form onSubmit={e => {
                handleSubmit(e)
                ...
                <IonCard class="card-login">
                    <IonItem>
                        ...
                        <IonSelect disabled defaultValue={parkingType} interface="popover" value={parkingType} placeholder="Seleccione uno" >
                    ...
                    <IonItem>
                      ...
                      <IonLabel position="floating">Cantidad de estacionamientos</IonLabel>
                      <IonInput color='dark' required={true} autocomplete='off' type="number" value={numPositions} onIonChange={(e: any) => {e.preventDefault();setNumPositions(Number(e.target.value))}} />
                    </IonItem>
                    <IonItemGroup>
                                ...
                                <IonRow>
                                    <IonCol>
                                        <IonItem>
                                            ...
                                            <IonDatetime displayFormat="HH:mm" value={LVStart} onIonChange={e => setLVStart(e.detail.value!)}></IonDatetime>
                                        </IonItem>
                                    </IonCol>
                                    <IonCol>
                                        <IonItem>
                                            <IonLabel>Cierra a:</IonLabel>
                                            <IonDatetime  displayFormat="HH:mm" value={LVEnd} onIonChange={e => setLVEnd(e.detail.value!)}></IonDatetime>
                                        </IonItem>
                                    </IonCol>
                                </IonRow>
                            </IonGrid>
                            ...
                            <IonGrid>                                
                                ...
                                <IonRow>
                                    <IonCol>
                                        <IonItem>
                                            <IonLabel >Abre a:</IonLabel>
                                            <IonDatetime displayFormat="HH:mm" value={SaStart} onIonChange={e => setSaStart(e.detail.value!)}></IonDatetime>
                                        </IonItem>
                                    </IonCol>
                                    <IonCol>
                                        <IonItem>
                                            <IonLabel>Cierra a:</IonLabel>
                                            <IonDatetime displayFormat="HH:mm" value={SaEnd} onIonChange={e => setSaEnd(e.detail.value!)}></IonDatetime>
                                        </IonItem>
                                    </IonCol>
                                </IonRow>
                            </IonGrid>
                              ...
                              <IonLabel>Domingos</IonLabel>
                                <IonRow>
                                    <IonCol>
                                        <IonItem>
                                            <IonLabel >Abre a:</IonLabel>
                                            <IonDatetime displayFormat="HH:mm" value={SuStart} onIonChange={e => setSuStart(e.detail.value!)}></IonDatetime>
                                        </IonItem>
                                    </IonCol>
                                    <IonCol>
                                        <IonItem>
                                            <IonLabel>Cierra a:</IonLabel>
                                            <IonDatetime displayFormat="HH:mm" value={SuEnd} onIonChange={e => setSuEnd(e.detail.value!)}></IonDatetime>
                                        </IonItem>
                                    </IonCol>
                                </IonRow>
                            </IonGrid>
