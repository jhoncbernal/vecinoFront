...
import styles from "./SadVecinoIcon.module.css";

interface SadVecinoIconProps extends React.SVGProps<SVGSVGElement> {
  fill?: string;
}

const SadVecinoIcon: React.FC<SadVecinoIconProps> = ({
  fill = "#000000",
  ...props
}) => {
  return (
    <div className={styles.iconWrapper}>
      ...
      <div className={styles.eye} style={{ top: "40%", left: "35%" }}></div>
      <div className={styles.eye} style={{ top: "40%", right: "35%" }}></div>
    </div>
  );
};

export default SadVecinoIcon;
