...
const BestListContainer: React.FC<ContainerProps> = ({ dataModal }) => {
    ...
    return (<>
        <IonToolbar color='primary'>
            <IonTitle><h1>Mejores Puntajes</h1></IonTitle>
        </IonToolbar>
        <IonContent>
                    ...
                    return (
                        <IonItemSliding key={index} >
                            ...
                            <IonAvatar slot="start">
                                <IonIcon class='icon-avatar' size='large' color={Number(input.debt) > 0 ? 'danger' : 'primary'} src={personOutline} />
                            </IonAvatar>
                            <IonLabel>
