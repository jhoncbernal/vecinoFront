...
const HomeUserContainer: React.FC<ContainerProps> = ({ history,currentUser }) => {
  ...
  return (
    <>
       <IonCard class="card-login">
          ...
          {segmentValue
            ? <>{
            segmentValue==='provider' && hiddenBar ? (<ListContainer loaddata={loadData} inputs={productsArray} currentUser={currentUser}></ListContainer>)
